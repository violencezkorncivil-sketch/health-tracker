...
["ไข่ต้ม",78,6.3,0.6,5.3,"1 ฟอง","กับข้าว",0,62,1.6,0.6,0,63],   // ค่าละเอียดจาก USDA 173424
...
["หมูปิ้ง",90,7,4,5,"1 ไม้","กับข้าว",0,270,2.4,3,0,110],   // คำนวณจากส่วนผสม: หมู 35 ก. + น้ำตาล/นมข้น/กะทิ + น้ำปลา-ซีอิ๊ว
["ไก่ปิ้ง",80,9,2,4,"1 ไม้","กับข้าว",0,220,1.2,1.5,0,100],   // คำนวณจากส่วนผสม: ไก่ 35 ก. + น้ำตาลหมัก + ซีอิ๊ว
...
["Regency + โซดา (1 ฝา)",59,0,0,0,"1 แก้ว (1 ฝา)","เครื่องดื่ม",0,10,0,0,8.3,0],   // USDA:Alcoholic beverage, distilled, whiskey, 86 p
...
["โซดา",0,0,0,0,"1 แก้ว","เครื่องดื่ม",0,15,0,0,0,2],
...
["สเต๊กเนื้อสันนอก 1 จาน (เนื้อ 200 ก.)",700,62.0,26.0,37.0,"1 จาน","จานเดียว",2.5,900,12.0,4.0,0,920],
["สเต๊กเนื้อ ร้านทั่วไป 1 จาน (เนื้อ 120 ก. + เฟรนช์ฟรายส์)",770,41.6,54.0,39.8,"1 จาน","จานเดียว",4.6,830,11.0,6.0,0,715],
["สเต๊กริบอาย 1 จาน (เนื้อ 250 ก.)",700,66.0,3.0,47.0,"1 จาน","จานเดียว",0.3,700,20.0,1.0,0,900],
["สเต๊กหมู 1 จาน (ร้านทั่วไป)",750,45.0,52.0,40.0,"1 จาน","จานเดียว",4.5,800,12.0,6.0,0,890],
["สเต๊กอกไก่ 1 จาน (ไก่ 180 ก.)",650,52.0,45.0,29.0,"1 จาน","จานเดียว",4.5,850,7.5,5.0,0,870],
["สเต๊กปลาแซลมอน 1 จาน",630,42.0,35.0,34.0,"1 จาน","จานเดียว",3.5,750,8.0,4.0,0,1000],
...
["ก๋วยเตี๋ยวเนื้อตุ๋น 1 ชาม",380,27.5,34.0,11.6,"1 ชาม","ก๋วยเตี๋ยว",1.8,1950,4.5,3.0,0,520],
["แกงมัสมั่นเนื้อ 1 ถ้วย",480,30.0,19.0,30.5,"1 ถ้วย","กับข้าว",2.0,1000,18.0,6.0,0,630],
["พะโล้เนื้อ 1 ถ้วย",290,33.0,10.0,12.5,"1 ถ้วย","กับข้าว",0.2,1000,4.5,8.0,0,400],
["สตูว์เนื้อ 1 ถ้วย",350,29.0,25.0,14.0,"1 ถ้วย","กับข้าว",2.5,750,5.0,4.0,0,600],
...
["เนื้อผัดน้ำมันหอย 1 จาน",345,28.0,9.0,21.0,"1 จาน","กับข้าว",2.0,1300,6.0,2.0,0,560],
["ยำเนื้อย่าง 1 จาน",250,29.0,9.0,9.0,"1 จาน","กับข้าว",1.8,850,3.5,4.0,0,590],
["เนื้อย่างเกาหลี (บุลโกกิ) 1 จาน",490,38.0,17.0,28.0,"1 จาน","กับข้าว",0.8,900,9.0,13.0,0,480],

// ===== ปิ้งย่างเป็นไม้/เป็นชิ้น (คำนวณจากส่วนผสม — ค่าประมาณ) =====
["หมูปิ้งไม้ใหญ่",165,12.5,6.0,9.5,"1 ไม้ ~60 ก.","กับข้าว",0,480,4.2,5.5,0,200],
["หมูปิ้งติดมัน (คอหมู) 1 ไม้",130,7.5,3.5,9.5,"1 ไม้","กับข้าว",0,280,3.5,3.3,0,140],
...
["กาแฟอเมริกาโน่ (ไม่ใส่น้ำตาล)",5,0.2,0,0,"1 แก้ว","เครื่องดื่ม",0,5,0,0,0,34],   // USDA:Beverages, coffee, brewed, espresso, restaur
["กาแฟคาปูชิโน่ (ไม่ใส่น้ำตาล)",75,4.0,6.0,4.0,"1 แก้ว 240 มล.","เครื่องดื่ม",0,55,2.4,0,0,230],
["กาแฟลาเต้เย็น (ไม่ใส่น้ำตาล)",112,6.0,9.0,6.0,"1 แก้ว","เครื่องดื่ม",0,80,3.6,0,0,195],
["กาแฟมอคค่าเย็น",320,8.0,45.0,12.0,"1 แก้ว","เครื่องดื่ม",1.5,130,7.0,34,0,210],
["ชาเขียวเย็น (หวานปกติ)",200,1.5,45.0,2.0,"1 แก้ว","เครื่องดื่ม",0,60,1.2,42,0,92],   // USDA:Beverages, tea, black, brewed, prepared with
["ชาดำเย็น (หวาน)",180,0,45.0,0,"1 แก้ว","เครื่องดื่ม",0,20,0,44,0,92],   // USDA:Beverages, tea, black, brewed, prepared with
["ชามะนาว (หวาน)",150,0,38.0,0,"1 แก้ว","เครื่องดื่ม",0,15,0,36,0,92],   // USDA:Beverages, tea, black, brewed, prepared with
["โกโก้ร้อน (ใส่นม+น้ำตาล)",220,8.0,30.0,8.0,"1 แก้ว","เครื่องดื่ม",2.0,130,4.5,22,0,492],   // USDA:Milk, chocolate beverage, hot cocoa, homemad
["ไมโล/โอวัลติน 1 แก้ว",200,7.0,30.0,5.5,"1 แก้ว","เครื่องดื่ม",0.6,150,3.2,20,0,458],   // USDA:Beverages, Malted drink mix, natural, powder
...
function adaptiveTDEE(){
  ...
  if(real<lo || real>hi)
    return {suspect:true, real, avgIn, dW:n1(dW), span, days:fd.length, formula:S.user.tdee, lo, hi};
